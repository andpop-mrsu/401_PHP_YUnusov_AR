...
SQLite3
Запуск Task02
Перейти в каталог Task02: cd Task02
Запустить встроенный веб-сервер PHP: php -S localhost:3000 -t public
Открыть приложение в браузере: http://localhost:3000/ или http://localhost:3000/index.html